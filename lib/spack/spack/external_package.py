...
class PackagesConfig(object):
    ...
    def __init__(self, scope):
        ...
        """
        self.scope = scope
        config = spack.config.config.get_config("packages", scope)
    ...
    def update_package_config(self, package_entry):
        ...
        """
        spack.config.config.update_config("packages", package_entry, self.scope)
    ...
    def _overwrite_package_config(self):
        scope = spack.config.config.validate_scope(self.scope)
